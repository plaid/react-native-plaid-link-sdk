...
describe('Type Definitions', () => {
  describe('Enums', () => {
    ...
    describe('LinkErrorCode', () => {
      ...
      it('has institution error codes', () => {
        ...
        expect(LinkErrorCode.INSTITUTION_NOT_RESPONDING).toBe('INSTITUTION_NOT_RESPONDING');
      });

      it('has API error codes', () => {
        expect(LinkErrorCode.INTERNAL_SERVER_ERROR).toBe('INTERNAL_SERVER_ERROR');
    ...
    describe('LinkAccountVerificationStatus', () => {
      it('has correct values', () => {
        expect(LinkAccountVerificationStatus.PENDING_AUTOMATIC_VERIFICATION).toBe('pending_automatic_verification');
        expect(LinkAccountVerificationStatus.PENDING_MANUAL_VERIFICATION).toBe('pending_manual_verification');
        expect(LinkAccountVerificationStatus.MANUALLY_VERIFIED).toBe('manually_verified');
      });
    });
    ...
    describe('LinkExitMetadataStatus', () => {
      it('has correct values', () => {
        ...
        expect(LinkExitMetadataStatus.REQUIRES_CREDENTIALS).toBe('requires_credentials');
  ...
  describe('LinkAccountSubtype Classes', () => {
    ...
    describe('LinkAccountSubtypeUnknown', () => {
      it('handles arbitrary types', () => {
        const unknown = new LinkAccountSubtypeUnknown('custom_type', 'custom_subtype');
  ...
  describe('Complex Type Scenarios', () => {
    it('LinkSuccess with all optional fields', () => {
      ...
      expect(linkSuccess.metadata.accounts[0].verificationStatus).toBe('manually_verified');
    });
