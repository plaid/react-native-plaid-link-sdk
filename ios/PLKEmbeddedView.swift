  ...
  private func makeHandler() throws -> Handler {
    var config = LinkTokenConfiguration(
      ...
      onSuccess: { [weak self] success in
        ...
        var dictionary = JSONHelper.dictionaryFromSuccess(success: success)
    ...
    config.onEvent = { [weak self] event in
      ...
      var dictionary = JSONHelper.dictionaryFromEvent(event)
    ...
    config.onExit = { [weak self] exit in
      ...
      var dictionary = JSONHelper.dictionaryFromExit(exit: exit)
